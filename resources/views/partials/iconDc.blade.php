<div id="iconDc" class="my_bg_blue text-white">
    <div class="row my_box_container justify-content-between">
        <div class="col-auto py-3 d-flex align-items-center gap-2">
